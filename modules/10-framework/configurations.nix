{
  ...
  publicModuleAttrs = attrs:
    lib.filterAttrs
    (name: _value: !(lib.hasPrefix "_" name))
    attrs;
  ...
  nixosFeatureOptionsModule = {lib, ...}: {
    options.local = {
      ...
      context.flakePath = lib.mkOption {
        type = lib.types.str;
        default = "/home/tenzyu/.nixfiles";
      };
    };
  };
            ...
            [
              ...
              nixpkgsPolicyModule
              {
                ...
                local.context = {
                  ...
                  nixosConfigurationName = config.networking.hostName;
                  homeConfigurationName = "${userName}@${config.networking.hostName}";
